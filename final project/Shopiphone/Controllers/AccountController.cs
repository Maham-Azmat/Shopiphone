...
namespace Shopiphone.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private string var = "owner@gmail.com";
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                model.Scanned_CNIC = "~/Image/" + fileName;
                fileName = Path.Combine(Server.MapPath("~/Image/"), fileName);
                model.ImageFile.SaveAs(fileName);
                var user = new ApplicationUser { Name = model.Name, UserName = model.Email, Email = model.Email, CNIC= model.CNIC, Address = model.Address, Accountno  = model.Accountno, Phoneno = model.Phoneno, Scanned_CNIC = model.Scanned_CNIC  };
